Feature: Create Intervention
    In order to add comments and scores to groups of interventions
    A SIMS USER
    Should be able to add scores, comments and participants using the grouped progress entry


    Scenario: Add Particioant
        Given PENDING I am on the grouped progress screen
        When PENDING I add 2 participants
        Then PENDING the interventions should have the added participants
        And PENDING there should be 2 emails

    Scenario: Other Scenarios
        Given PENDING You need to test this
