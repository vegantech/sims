Feature: Asset Upload
  ...
  A District Admin (In this case)

	Scenario: Add document
		Given I am a district admin
		When I go to the home page
		Then I should not see "District Documents" within "#left_column"
		And I follow "Edit your district"
		And I attach the file "README.md" to "File:"
		When I press "Update"
		Then I should see "District Documents"
		And I follow "README"
		
	Scenario: Add document with vailed validation
		Given I am a district admin
		When I go to the home page
		Then I should not see "District Documents" within "#left_column"
		And I follow "Edit your district"
		...
		When I press "Update"
		And I fill in "Name" with "Filled In"
		When I press "Update"
		Then I should see "District Documents"
		And I follow "README"
		
		Scenario: Add document with vailed validation multiple times
		Given I am a district admin
		When I go to the home page
		Then I should not see "District Documents" within "#left_column"
		And I follow "Edit your district"
