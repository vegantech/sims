...
describe School::StudentsController do
  ...
  describe "responding to GET index" do
    ...
    it "should expose all school_students as @school_students" do
      Student.should_receive(:find).with(:all).and_return([mock_student])
      get :index
      assigns[:school_students].should == [mock_student]
    end

    describe "with mime type of xml" do
  
      it "should render all school_students as xml" do
        request.env["HTTP_ACCEPT"] = "application/xml"
        Student.should_receive(:find).with(:all).and_return(students = mock("Array of School::Students"))
  ...
  describe "responding to POST create" do
    ...
    describe "with valid params" do
      ...
      it "should redirect to the created student" do
        ...
        post :create, :student => {}
        response.should redirect_to(school_student_url(mock_student))
      end
  ...
  describe "responding to DELETE destroy" do
    ...
    it "should redirect to the school_students list" do
      Student.stub!(:find).and_return(mock_student(:destroy => true))
      delete :destroy, :id => "1"
      response.should redirect_to(school_students_url)
    end
