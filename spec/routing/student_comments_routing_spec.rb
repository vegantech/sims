...
describe StudentCommentsController do
  describe "route generation" do
    it "should map #index" do
      route_for(:controller => "student_comments", :action => "index",:student_id => "2").should == "/students/2/student_comments"
    end
  ...
  describe "route recognition" do
    it "should generate params for #index" do
      params_from(:get, "/students/2/student_comments").should == {:controller => "student_comments", :action => "index",:student_id=>"2"}
    end
