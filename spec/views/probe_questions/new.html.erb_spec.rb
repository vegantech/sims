...
describe "/probe_questions/new.html.erb" do
  include ProbeQuestionsHelper
  
  before(:each) do
    assigns[:probe_question] = stub_model(ProbeQuestion,
      :new_record? => true,
      :probe_definition => ,
      :number => "1",
  ...
  it "should render new form" do
    render "/probe_questions/new.html.erb"
    
    response.should have_tag("form[action=?][method=post]", probe_questions_path) do
