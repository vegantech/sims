...
describe InterventionDefinitionSummaryReport do
  describe 'render_text' do
    it 'should generate correct text output' do
      # od = ObjectiveDefinition.create!(:title => 'Uppity', :description => 'Student does not know their place.')
...
+-------------------------------------------------------------------------------------------------------------------------------------+
| 1-1-1    -1-1 | IC-TITLE | <b>ID-TITLE</b> | ID-TITLEDescription | 1 Default / 1 time   |                   |                       |
+-------------------------------------------------------------------------------------------------------------------------------------+
