...
describe 'Use Old Fixtures Key' do
  ...
  describe "Fixtures.identify" do
    it "should match the earlier rails2.3 and ruby 1.8.6 values" do
      ...
      Fixtures.identify(:recommendation_answer_definition_00001).should == 1   #used for seeding new districts
      Fixtures.identify(:weekly).should == 680074761  #also used for seeding new districts
