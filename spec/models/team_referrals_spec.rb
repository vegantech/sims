...
describe TeamReferrals do
  ...
  describe "gather_information_request" do
    it 'should send the email' do
      ...
      @mail.body.should == "First Last has been discussed at our team meeting.  \nPlease share information based on your perspective by going to <a href=\"http://www.sims_test_host/students/#{student.id}\">First Last</a>, then click on Respond to Request for Information under the Team Notes heading.\n\n\nRequested by: #{requestor.first_name} Last_Name\n"
    end
  end
