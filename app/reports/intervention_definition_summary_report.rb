...
class InterventionDefinitionSummary
  ...
  def to_table
    ...
    if a.column_names.present?
      cls = ["description", "monitor_summary", "frequency_duration_summary", "tier_summary", "business_key","links_and_attachments", "bolded_title",  "intervention_cluster.title", "sld"]
